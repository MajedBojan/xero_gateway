...
require File.join(File.dirname(__FILE__), 'xero_gateway', 'oauth2', 'access_token_adapter')
require File.join(File.dirname(__FILE__), 'xero_gateway', 'oauth2', 'response_adapter')